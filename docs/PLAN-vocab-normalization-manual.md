...
Ví dụ thư mục:
- `assets/data/vocab/n5/lesson_01/master.json`
- `assets/data/vocab/n5/lesson_01/sense.json`
- `assets/data/vocab/n5/lesson_01/map.json`
...
- [x] Tạo thư mục n4 (new lesson structure): `assets/data/vocab/n4/`.
...
- [x] Final QA N4 (26-50): da sua 96 muc term/reading bi placeholder `?` o cac dong bo sung web-check (lesson 26-40), va re-validate integrity toan bo N4 (26-50) pass.
- [x] Data cleanup (N4+N5): da chuan hoa `kanjiMeaning` tieng Viet, sua loi dau/ky tu cho cac gia tri bi moji/`?` tren toan bo `assets/data/vocab/*/lesson_*/master.json`.
- [x] Data cleanup (N4+N5): da chuan hoa `meaningVi`, sua loi dau/ky tu tren toan bo `assets/data/vocab/*/lesson_*/sense.json` (khong con ky tu moji/`?` noi bo tu).
- [x] Final cleanup kickoff: audited N4/N5 coverage before delete; new lesson structure keeps 100% legacy term+reading coverage (0 missing), with +387 curated rows from web-check.
