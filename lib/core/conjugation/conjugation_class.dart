...
class ConjugationSpec {
  ...
  static ConjugationSpec? fromJmDictPos(
    ...
    if (has('vs') || has('vs-i') || has('vs-s') || has('vs', 'suru verb')) {
    ...
    if (has('v5u', "godan verb with 'u' ending")) {
      return const ConjugationSpec.verb(VerbClass.godanU);
    }
    if (has('v5k', "godan verb with 'ku' ending")) {
      return const ConjugationSpec.verb(VerbClass.godanKu);
    }
    if (has('v5g', "godan verb with 'gu' ending")) {
      return const ConjugationSpec.verb(VerbClass.godanGu);
    }
    if (has('v5s', "godan verb with 'su' ending")) {
      return const ConjugationSpec.verb(VerbClass.godanSu);
    }
    if (has('v5t', "godan verb with 'tsu' ending")) {
      return const ConjugationSpec.verb(VerbClass.godanTsu);
    }
    if (has('v5n', "godan verb with 'nu' ending")) {
      return const ConjugationSpec.verb(VerbClass.godanNu);
    }
    if (has('v5b', "godan verb with 'bu' ending")) {
      return const ConjugationSpec.verb(VerbClass.godanBu);
    }
    if (has('v5m', "godan verb with 'mu' ending")) {
      return const ConjugationSpec.verb(VerbClass.godanMu);
    }
    if (has('v5r', "godan verb with 'ru' ending")) {
      return const ConjugationSpec.verb(VerbClass.godanRu);
    }
