...
- QA-B-001 grammar: N2 lessons 01-25 source-verified, deployed, live-rendered; AppDatabase grammar reseed revision is `16`.
...
- Next batch: QA-B-001 grammar N3 lessons 01-05.
