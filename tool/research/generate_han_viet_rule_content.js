...
const RULE_SPECS = [
  ...
  {
    ruleId: 'rule_rime_ac_uoc_to_aku_yaku',
    legacyId: 'rime-ac-uoc-to-aku-yaku',
    section: '21',
    category: 'rime',
    title: 'Vần -ác/-ạc/-ước/-ược',
    consonants: [],
    targetRow: 'AKU/YAKU',
    targetKana: ['く'],
    hanVietEndings: ['ac', 'uoc'],
    onyomiEndings: ['く'],
    percentage: 66,
    explanation:
      "Các vần Hán-Việt -ác/-ạc/-ước/-ược thường khép bằng -aku/-yaku trong On'yomi.",
    priorityKanji: ['学', '楽', '薬', '約', '悪', '各', '客', '格'],
  },
  {
    ruleId: 'rule_rime_ich_to_eki_seki',
    legacyId: 'rime-ich-to-eki-seki',
    section: '22',
    category: 'rime',
    title: 'Vần -ịch/-ích',
    consonants: [],
    targetRow: 'EKI/SEKI/TEKI',
    targetKana: ['き'],
    hanVietEndings: ['ich'],
    onyomiEndings: ['き'],
    percentage: 64,
    explanation:
      "Các vần Hán-Việt -ịch/-ích thường đi với nhịp -eki/-seki/-teki trong On'yomi.",
    priorityKanji: ['駅', '液', '益', '易', '席', '昔', '適', '歴'],
  },
  {
    ruleId: 'rule_rime_uu_ieu_yeu_to_yuu_you',
    legacyId: 'rime-uu-ieu-yeu-to-yuu-you',
    section: '23',
    category: 'rime',
    title: 'Vần -ưu/-iêu/-yêu',
    consonants: [],
    targetRow: 'YUU/YOU',
    targetKana: ['う'],
    hanVietEndings: ['uu', 'ieu', 'yeu'],
    onyomiEndings: ['う'],
    percentage: 68,
    explanation:
      "Các vần Hán-Việt -ưu/-iêu/-yêu thường chuyển sang yuu/you trong On'yomi.",
    priorityKanji: ['休', '九', '究', '友', '有', '要', '曜', '様'],
  },
  {
    ruleId: 'rule_long_vowel_ou_from_ang_ong',
    legacyId: 'long-vowel-ou-from-ang-ong',
    section: '24',
    category: 'long_vowel',
    title: 'Trường âm OU từ -ang/-ong/-ông',
    consonants: [],
    targetRow: 'OU',
    targetKana: ['う'],
    hanVietEndings: ['ang', 'ong'],
    onyomiEndings: ['う'],
    percentage: 70,
    explanation:
      "Một số vần Hán-Việt -ang/-ong/-ông chuyển thành trường âm ou trong On'yomi.",
    priorityKanji: ['方', '東', '工', '公', '校', '当', '堂', '黄'],
  },
  {
    ruleId: 'rule_long_vowel_ei_from_inh_anh',
    legacyId: 'long-vowel-ei-from-inh-anh',
    section: '25',
    category: 'long_vowel',
    title: 'Trường âm EI từ -inh/-anh/-ênh',
    consonants: [],
    targetRow: 'EI',
    targetKana: ['い'],
    hanVietEndings: ['inh', 'anh', 'enh'],
  ...
  {
    ruleId: 'rule_usage_han_viet_is_heuristic',
    legacyId: 'usage-hv-is-heuristic-not-reading-source',
    section: '31',
    category: 'usage',
    title: 'Hán-Việt là gợi ý, không phải đáp án',
    consonants: [],
    targetRow: 'HEURISTIC',
    targetKana: ['候補'],
    percentage: 100,
    explanation:
      "Âm Hán-Việt giúp thu hẹp ứng viên On'yomi, nhưng đáp án luyện phải là cách đọc Nhật đã xác nhận.",
    candidateKanji: [
      '行',
      '上',
      '生',
    ...
    practiceExplanation:
      "{hanViet} chỉ là tín hiệu gợi ý; chọn On'yomi đã được dữ liệu học xác nhận.",
  },
  {
    ruleId: 'rule_usage_multiple_on_readings',
    legacyId: 'usage-multiple-on-readings',
    section: '32',
    category: 'usage',
    title: 'Một kanji có thể có nhiều âm On',
    consonants: [],
    targetRow: 'MULTIPLE ON',
    targetKana: ['音1', '音2'],
    percentage: 100,
    explanation:
      "Nhiều kanji có hơn một âm On; học theo ví dụ từ ghép và kiểm cách đọc được dùng trong ngữ cảnh.",
    candidateKanji: [
      '行',
      '上',
      '生',
    ...
    practiceExplanation:
      '{hanViet} có thể có nhiều âm On; câu này luyện cách đọc đang dùng trong dữ liệu học.',
  },
];
